...
API_KEY = "X51GudBOO3ZRQLfYbghe7-wxk3sx8gjehK0AUurC7om3"
...
scale = pickle.load(open('scalare.pkl','rb'))
...
def predict():
    ...
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/3db3d589-8548-4fa2-843f-e06a335e6989/predictions?version=2022-11-18', json=payload_scoring,headers={'Authorization': 'Bearer ' + mltoken})
